...
const Modal = ({children,variant,heading,description,buttons, ...props}) => {
                                    ...
                                    <div className={Styles.modalBottomWrapper}>
                                        {
                                            ...
                                            return (
                                                <button className={`${Styles.btn} ${data.state === "active" ? Styles.active : ""} ${data.state === "deactive" ? Styles.deactive : ""} ${data.state === "cancel" ? Styles.cancel : ""}`} onClick={data.state === "cancel" ? closeModal : null} >{data.text}</button>
                                                );
                                            })
                                        }
                                    </div>
